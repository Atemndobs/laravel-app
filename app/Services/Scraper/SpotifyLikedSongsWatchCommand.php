...
class SpotifyLikedSongsWatchCommand extends Command
{
    ...
    public function handle()
    {
       ...
       // $playlistSearch = $spotifyService->getPlaylistByName($playlist);
        // get id for  playlist with name $playlist and tspe playlist
        ...
        $playlistData = [
            ...
            'tracks' => $playlist['tracks']['total'],
            'url' => $playlist['external_urls']['spotify'],
          //  'date_created' => $playlist['tracks']['items'][0]['added_at'],
        ];
