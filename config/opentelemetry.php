...
return [
     ...
     * Service name
     */
    'service_name' => env('OTEL_SERVICE_NAME', \Illuminate\Support\Str::slug(env('APP_NAME', 'curator'))),
    ...
    'exporters' => [
        'otlp' => [
            'endpoint' => env('OTEL_EXPORTER_OTLP_TRACES_ENDPOINT', env('OTEL_EXPORTER_OTLP_ENDPOINT', 'http://otel:4318')),
...
// Supported: "grpc", "http/protobuf", "http/json"
        ...
        'http' => [
            'endpoint' => env('OTEL_EXPORTER_HTTP_ENDPOINT', 'http://otel:4318'),
        ],
        'grpc' => [
            'endpoint' => env('OTEL_EXPORTER_GRPC_ENDPOINT', 'http://otel:4317'),
        ],

        'zipkin' => [
            'endpoint' => env('OTEL_EXPORTER_ZIPKIN_ENDPOINT', 'http://zipkin:9411'),
        ],
        'jaeger' => [
            'endpoint' => env('OTEL_EXPORTER_ZIPKIN_ENDPOINT', 'http://jaeger:16686'),
        ],
        'loki' => [
            'endpoint' => env('OTEL_EXPORTER_LOKI_ENDPOINT', 'http://loki:3100'),
        ],
