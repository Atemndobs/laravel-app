...
/usr/local/bin/docker exec -it mariadb_master_1 mysql -uroot -pmage mysql -e";
...
mysql --database=mage --user=mage -pmage --host=localhost --port=4005 <  storage/app/backups/latest/db-dumps/mysql-mage.sql
